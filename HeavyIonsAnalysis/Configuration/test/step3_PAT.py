...
# with command line options: step3 --conditions auto:phase1_2018_realistic_hi -s PAT --datatier MINIAODSIM -n 2 --era Run2_2018 --eventcontent MINIAODSIM --no_exec --runUnscheduled
