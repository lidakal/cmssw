void draw_dcc()
{
    ...
    TFile *fin_LTH4_HTH8 = new TFile("jobs/DoSR_LTH4p0_HTH8p0_NoZS_MIEB8p0_MIEE8p0/srvalid_hi2025setup_r399002.root");
    TH1F *h_eb_target = (TH1F *) fin_LTH4_HTH8->Get("ecalSelectiveReadoutValidation/hDccVol20")->Clone("h_eb_target");

    TFile *fin_LTH8_HTH10 = new TFile("jobs/DoSR_LTH8p0_HTH10p0_NoZS_MIEB8p0_MIEE8p0/srvalid_hi2025setup_r399002.root");
    ...
    TFile *fin_LTH10_HTH14 = new TFile("jobs/DoSR_LTH10p0_HTH14p0_NoZS_MIEB8p0_MIEE8p0/srvalid_hi2025setup_r399002.root");
