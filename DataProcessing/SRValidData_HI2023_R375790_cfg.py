'''
    ...
    PbPb TARGET
    BARREL LTH=4, HTH=8, ZS=8
    ENDCAP LTH=8, HTH=10, ZS=8

    PbPb SAFE
    BARREL LTH=8, HTH=10, ZS=8
    ENDCAP LTH=10, HTH=14, ZS=8
'''
...
process.source = cms.Source("PoolSource",
      fileNames = cms.untracked.vstring(
          "/store/hidata/HIRun2023A/HIMinimumBias0/RAW/v1/000/375/790/00000/09511448-3ff5-4b29-abf0-2140e4f6271e.root"
        )
)
...
process.ecalSelectiveReadoutValidation.outputFile = 'srvalid_HI2023_R375790.root'
...
process.p1 = cms.Path(process.Trigger*process.ecalEBunpacker*process.simEcalDigis*process.ecalSelectiveReadoutValidation)
#
...
process.TFileService = cms.Service("TFileService",
                                fileName = cms.string("srvalid_HI2023_R375790.root"))
