...
process.CondDBCommon.connect = 'sqlite_file:EcalSRSettings_NoSR_NoZS_MIEB8p0_MIEE8p0.db'
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    toPut = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('EcalSRSettings_NoSR_NoZS_MIEB8p0_MIEE8p0')
    ))
)
...
# ZS energy threshold in GeV to apply to low interest channels of barrel
process.writeInDB.ebDccAdcToGeV = cms.double(0.035)
process.writeInDB.srpBarrelLowInterestChannelZS = cms.double(EBLIZS*0.035) 

# ZS energy threshold in GeV to apply to low interest channels of endcap
process.writeInDB.eeDccAdcToGeV = cms.double(0.06)
process.writeInDB.srpEndcapLowInterestChannelZS = cms.double(EELIZS*0.06)

#process.writeInDB.srpBarrelHighInterestChannelZS = cms.double(EBHIZS*0.035) 
#process.writeInDB.srpEndcapHighInterestChannelZS = cms.double(EEHIZS*0.06)

#process.writeInDB.trigPrimBypass = cms.bool(True)
#process.writeInDB.trigPrimBypassMode = cms.int32(1)
#process.writeInDB.trigPrimBypassHTH = cms.double(10.0)
#process.writeInDB.trigPrimBypassLTH = cms.double(8.0)
