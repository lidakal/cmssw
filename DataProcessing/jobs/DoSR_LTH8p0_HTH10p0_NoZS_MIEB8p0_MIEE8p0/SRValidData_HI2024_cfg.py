...
#Input files
import sys
sys.path.insert(0,"/afs/cern.ch/user/l/lkalipol/private/ecal-hin/CMSSW_14_0_15/src/DataProcessing/filelists")
run = "388122"
modulename = "files_"+run+"_cfi"
module = __import__(modulename)
process.source = cms.Source("NewEventStreamFileReader",
      fileNames = module.readFiles
)
fout = "srvalid_hi2024_r"+run+".root"
...
process.ecalEBunpacker.InputLabel =  cms.InputTag("rawPrimeDataRepacker") # cms.InputTag("rawDataRepacker") # cms.InputTag("rawDataCollector")
...
process.ecalSelectiveReadoutValidation.outputFile = fout
...
simEcalDigis.trigPrimBypassLTH = cms.double(8.0)
simEcalDigis.trigPrimBypassHTH = cms.double(10.0)


process.GlobalTag.toGet = cms.VPSet(
 cms.PSet(record = cms.string("EcalSRSettingsRcd"),
   tag = cms.string("EcalSRSettings_DoSR_LTH8p0_HTH10p0_NoZS_MIEB8p0_MIEE8p0"),
   connect = cms.string("sqlite_file:EcalSRSettings_DoSR_LTH8p0_HTH10p0_NoZS_MIEB8p0_MIEE8p0.db")
 )
)
