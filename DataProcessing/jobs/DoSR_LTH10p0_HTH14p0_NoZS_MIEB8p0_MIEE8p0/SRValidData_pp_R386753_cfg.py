...
process.source = cms.Source("PoolSource",
      fileNames = cms.untracked.vstring(
          "/store/data/Run2024I/SpecialZeroBias0/RAW/v1/000/386/753/00000/0001a82c-42c3-4626-9795-f168c3f49da4.root",
        )
)
...
process.ecalEBunpacker.InputLabel = cms.InputTag("rawDataCollector") # cms.InputTag("rawDataRepacker")
...
process.ecalSelectiveReadoutValidation.outputFile = 'srvalid_pp_R386753.root'
...
process.TFileService = cms.Service("TFileService",
                                fileName = cms.string("srvalid_pp_R386753.root"))
...
simEcalDigis.trigPrimBypassLTH = cms.double(10.0)
simEcalDigis.trigPrimBypassHTH = cms.double(14.0)


process.GlobalTag.toGet = cms.VPSet(
 cms.PSet(record = cms.string("EcalSRSettingsRcd"),
   tag = cms.string("EcalSRSettings_DoSR_LTH10p0_HTH14p0_NoZS_MIEB8p0_MIEE8p0"),
   connect = cms.string("sqlite_file:EcalSRSettings_DoSR_LTH10p0_HTH14p0_NoZS_MIEB8p0_MIEE8p0.db")
 )
)
