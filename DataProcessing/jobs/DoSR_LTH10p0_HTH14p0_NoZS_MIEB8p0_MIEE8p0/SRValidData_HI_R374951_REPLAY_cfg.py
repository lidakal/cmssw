'''
    REPLAY of run 374951 for 2024 data taking rehearsal
'''
...
process.source = cms.Source("PoolSource",
      fileNames = cms.untracked.vstring(
          ...
          "/store/backfill/1/hidata/Tier0_HIREPLAY_2024/HIMinimumBias0/RAW/v17225534/000/374/951/00000/e7de1bf3-629e-40c8-a0cd-f99aff06b92c.root"
        )
)
...
process.ecalSelectiveReadoutValidation.outputFile = 'srvalid_HI_R374951_REPLAY2024.root'
...
process.TFileService = cms.Service("TFileService",
                                fileName = cms.string("srvalid_HI_R374951_REPLAY2024.root"))
