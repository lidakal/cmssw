...
#Input files
import files_399465_cfi
process.source = cms.Source("NewEventStreamFileReader",
      fileNames = files_399465_cfi.readFiles
)
...
process.ecalEBunpacker.InputLabel = cms.InputTag("rawDataCollector") # cms.InputTag("rawPrimeDataRepacker") # cms.InputTag("rawDataRepacker") 
...
process.ecalSelectiveReadoutValidation.outputFile = 'srvalid_hi2025_r399465.root'
...
process.TFileService = cms.Service("TFileService",
                                fileName = cms.string("srvalid_hi2025_r399465.root"))
